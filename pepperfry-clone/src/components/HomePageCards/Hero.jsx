...
const Hero = () => {
  return (
    <>
        <HomeContainer style={{marginTop:"115px"}}>
            <div className="belowNavbar">
                <ImageSlider slides={SliderData}/>
                <img src="https://ii2.pepperfry.com/media/wysiwyg/banners/web_rhs_02022023_1.jpg" alt={"SideImage"} className="sideImage"/>
            </div>
            <RectangularBlock><img src="https://ii3.pepperfry.com/media/wysiwyg/banners/2021_web_regBanner_2202.jpg" alt={"T&C"}/></RectangularBlock>
            <h1>Shop By Room</h1>
            <Shop>
                <div>
